...
//
//     final videoViewModel = videoViewModelFromJson(jsonString);

import 'dart:convert';

VideoViewModel videoViewModelFromJson(String str) =>
    VideoViewModel.fromJson(json.decode(str));

String videoViewModelToJson(VideoViewModel data) => json.encode(data.toJson());
...
class CardData {
  ...
  Map<String, dynamic> toJson() => {
        "banner_v1": bannerV1 == null ? null : bannerV1!.toJson(),
        "area_entrance_v3":
            areaEntranceV3 == null ? null : areaEntranceV3!.toJson(),
        "activity_card_v1":
            activityCardV1 == null ? null : activityCardV1!.toJson(),
